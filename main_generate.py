...
def main(cfg: DictConfig):
    ...
    if dataset_config["name"] in ['math1']:
    ...
    if cfg.general.train_method in ["ddpo","gdpo"]:
        trainer = Trainer(accelerator='gpu' if torch.cuda.is_available() and cfg.general.gpus > 0 else 'cpu',
                        ...
                        strategy='ddp_find_unused_parameters' if cfg.general.gpus > 1 else None,
    ...
    if not cfg.general.test_only:
        if cfg.general.resume:
            ...
            sd_dict = {"math1":home_prefix+"pretrained/math1pretrained.pt"
                        }
            # sd_dict = {}
